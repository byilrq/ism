...
5. 如果需要添加域名：可以添加域名，域名对应的证书在/etc/letsencrypt/live下面
6. 反向代理的端口是2083，最后可以使用域名：2083访问。
7. 菜单项有1.安装 2.重启 3.添加每天自动备份数据库到/root/asset_manager/backups，滚动保留一份最新的数据库备份删除旧的备份文件；
8. 重启就是如果更新了更新完程序后重启：
